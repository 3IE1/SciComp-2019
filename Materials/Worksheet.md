...
- **structure** arrays (expandable tree of variables, which can each be of different size and type)
  - e.g. ```str.car(1) = 'Mazda'; str.car(1).colour = 'Blue'; str.car(1).lic = 34993434;```
...
#### Character arrays  
- Create two character arrays using string of characters; assign them variable names. example: ```char1 = 'my first string'``` ```char2 = 'is not my last'```
```str1 = 'Hello.'```
- Combine (concatenate) the two character arrays into a new single character array 
  - 

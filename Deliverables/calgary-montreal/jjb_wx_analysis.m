...
% 1950 to 2010 for the sites Calgary and Montreal
% Created 28-Jan by JJB


%% Import Calgary data
Calgary = importdata('D:\Local\EC_Wx\Data\station2205-1950-2010-daily.csv'); %change the path to match the location of your files
Montreal = importdata('D:\Local\EC_Wx\Data\station5415-1950-2010-daily.csv'); %change the path to match the location of your files
